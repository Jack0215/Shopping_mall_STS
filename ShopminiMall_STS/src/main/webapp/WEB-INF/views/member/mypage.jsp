 ...
 $("form").on("submit",function(event){		
	 ...
	 var passwd = $("#passwd").val();
    	...
    	$("form").on("submit",function(event){
    		...
    		if(email1.length==0||email2.legth==0){
    			event.preventDefault();
    			alert("email 확인");
    		}
    		
    	});//MemberController에 memberUpdate함수 작성 데이터 출력 까지 작성
...
MemberDTO dto =(MemberDTO)session.getAttribute("login");
    ...
    %>
 <!-- 멤버 업데이트 불러올건데, 로그인 되어있는 경우만 불러옴(인터셉트 사용) -->
<form action="LoginCheck/MemberUpdate" method="get"> <!-- method = post -> get으로 변경 -->
